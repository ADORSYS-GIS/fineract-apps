...
import { Shield, Check, Clock, AlertCircle, Upload, ChevronRight } from "lucide-react";
    ...
    <div className="space-y-6">
      ...
      <div className="card">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <span className={`inline-block text-sm px-3 py-1 rounded-full mt-1 ${getStatusColor(kycStatus as DocumentStatus["status"])}`}>
      ...
      {kycTier < 2 && (
        <div className="card">
          ...
          <div className="mt-6">
            <a href="/self-service/kyc/upload" className="btn-primary w-full text-center block">
              {t("kyc.upload")}
            </a>
          </div>
        </div>
