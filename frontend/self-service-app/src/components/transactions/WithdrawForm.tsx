...
import { ArrowUpCircle, Loader2, Check, Shield } from "lucide-react";
import { PaymentMethodSelector } from "./PaymentMethodSelector";
import { AmountInput } from "./AmountInput";
import { formatCurrency } from "../../lib/formatters";
import { requestStepUpAuth, isWebAuthnSupported, getAuthenticatorTypeLabel, hasPlatformAuthenticator } from "../../lib/webauthn";
...
interface WithdrawFormProps {
  ...
  currency?: string;
  accessToken: string;
  onSubmit: (data: { amount: number; paymentMethod: PaymentMethodId; stepUpToken?: string }) => Promise<void>;
  onSuccess?: () => void;
}
...
export function WithdrawForm({
  ...
  const [authenticatorLabel, setAuthenticatorLabel] = useState("Biometric / PIN");
    ...
    return (
      <div className="text-center py-8">
        ...
        <p className="text-gray-500 mb-4">
          {t("transactions.withdrawal")}: {formatCurrency(amount, currency)} {currency}
        </p>
        {selectedMethod && (
    ...
    return (
      <div className="text-center py-8">
        ...
        <p className="text-gray-500 mb-6">
          ...
          <strong>{formatCurrency(amount, currency)} {currency}</strong>
        </p>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="text-center">
        ...
        <h1 className="text-2xl font-bold text-gray-900">{t("transactions.withdrawal")}</h1>
