		...
		<div className="space-y-6">
			...
			<div className="border border-gray-200 rounded-lg p-4 space-y-3">
				<div className="flex items-center justify-between">
					...
					<label className="relative inline-flex items-center cursor-pointer">
						<input
							...
							onChange={(e) =>
								updateFormData({ tvaEnabled: e.target.checked })
							}
						/>
						<div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600" />
					</label>
				...
				{formData.tvaEnabled && (
					<div className="pt-2">
						...
						/>
						<p className="text-xs text-gray-400 mt-1">
							Leave at 0 to use the system default (19.25%). Applied to
							the trading fee amount only.
						</p>
					</div>
				)}
			</div>
			...
			<div className="bg-blue-50 border border-blue-200 rounded-lg p-4 text-sm text-blue-800">
				...
				<ul className="list-disc list-inside space-y-0.5 text-blue-700 text-xs">
					<li>Registration duty: 2% on transaction value (enabled by default)</li>
