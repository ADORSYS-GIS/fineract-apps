...
export const IncomeSummaryCard: FC<Props> = ({ assetId }) => {
	const { data, isLoading } = useQuery({
		queryKey: ["income-summary", assetId],
		queryFn: () => assetApi.getIncomeSummary(assetId),
		select: (res) => res.data,
	});
			...
			{isLoading ? (
				...
				<div className="space-y-3 text-sm">
					<div className="grid grid-cols-2 gap-4">
						<div>
							<p className="text-gray-500">Last Distribution</p>
