...
export class RescheduleLoanComponent {
	...
	bulkLoanReschedule(action: string) {
		const rescheduleLoanDialogRef = this.dialog.open(
			ConfirmationDialogComponent,
			{
				data: {
					heading: this.translateService.instant(
						"labels.heading.Reschedule Loan",
					),
					dialogContext:
						this.translateService.instant(
							"labels.dialogContext.Are you sure you want to",
						) +
						action +
						this.translateService.instant(
							"labels.dialogContext.the Reschedule Loan",
						),
				},
			},
		);
		rescheduleLoanDialogRef
			.afterClosed()
