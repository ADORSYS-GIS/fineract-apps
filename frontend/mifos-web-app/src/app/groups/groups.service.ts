...
export class GroupsService {
	...
	getFilteredGroups(
		...
		httpParams = orphansOnly
			? httpParams.set("orphansOnly", orphansOnly)
			: httpParams;
		return this.http.get("/groups", { params: httpParams });
	}
	...
	getGroupSummary(groupId: string): Observable<any> {
		...
		return this.http.get(`/runreports/GroupSummaryCounts`, {
			params: httpParams,
		});
	}
	...
	getGroupDatatable(groupId: string, datatableName: string): Observable<any> {
		...
		return this.http.get(`/datatables/${datatableName}/${groupId}`, {
			params: httpParams,
		});
	}
	 ...
	 * @returns {Observable<any>}
	 */
	addGroupDatatableEntry(
		groupId: string,
		datatableName: string,
		data: any,
	): Observable<any> {
		const httpParams = new HttpParams().set("genericResultSet", "true");
		return this.http.post(`/datatables/${datatableName}/${groupId}`, data, {
			params: httpParams,
		});
	}
	 ...
	 * @returns {Observable<any>}
	 */
	editGroupDatatableEntry(
		groupId: string,
		datatableName: string,
		data: any,
	): Observable<any> {
		const httpParams = new HttpParams().set("genericResultSet", "true");
		return this.http.put(`/datatables/${datatableName}/${groupId}`, data, {
			params: httpParams,
		});
	}
	...
	deleteDatatableContent(
		...
		const httpParams = new HttpParams().set("genericResultSet", "true");
		return this.http.delete(`/datatables/${datatableName}/${groupId}`, {
			params: httpParams,
		});
	}
	...
	getGroupCalendarAndTemplate(groupId: any, calendarId: any): Observable<any> {
		...
		return this.http.get(`/groups/${groupId}/calendars/${calendarId}`, {
			params: httpParams,
		});
	}
	...
	getMeetingsTemplate(groupId: any, calendarId: any): Observable<any> {
		...
		return this.http.get(`/groups/${groupId}/meetings/template`, {
			params: httpParams,
		});
	}
	 ...
	 * @returns {Observable<any>}
	 */
	assignGroupAttendance(
		groupId: any,
		calendarId: any,
		data: any,
	): Observable<any> {
		const httpParams = new HttpParams().set("calenderId", calendarId);
		return this.http.post(`/groups/${groupId}/meetings`, data, {
			params: httpParams,
		});
	}
