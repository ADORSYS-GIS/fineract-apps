...
export class EditGroupMeetingScheduleComponent implements OnInit {
	 ...
	 */
	submit() {
		const groupEditMeetingScheduleFormData =
		...
		const prevOldDate: Date = new Date(
			this.groupEditMeetingScheduleForm.value.presentMeetingDate,
		);
		const prevNewDate: Date =
			this.groupEditMeetingScheduleForm.value.newMeetingDate;
		if (groupEditMeetingScheduleFormData.presentMeetingDate instanceof Date) {
			groupEditMeetingScheduleFormData.presentMeetingDate =
				this.dateUtils.formatDate(prevOldDate, dateFormat);
		}
		if (groupEditMeetingScheduleFormData.newMeetingDate instanceof Date) {
			groupEditMeetingScheduleFormData.newMeetingDate =
