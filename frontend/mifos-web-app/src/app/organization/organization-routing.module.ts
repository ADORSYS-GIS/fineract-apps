			...
			children: [
				...
				},
				{
					...
					data: {
						...
						breadcrumb: "Provisioning Criteria",
					},
					children: [
						{
							path: "",
						...
						},
						{
							path: ":id",
							data: {
								title: "View Provisioning Criteria",
							...
							children: [
								...
								},
								{
									...
									resolve: {
										loanProvisioningCriteriaAndTemplate:
				...
				},
				{
					...
					data: {
						...
						breadcrumb: "Currency Configuration",
					},
					resolve: {
					...
					children: [
						...
						},
						{
							...
							data: {
								...
								breadcrumb: "Create Payment Type",
							},
						},
						{
							path: ":id",
				...
				},
				{
					...
					data: {
						...
						breadcrumb: "Password Preferences",
					},
					resolve: {
				...
				},
				{
					...
					data: {
						...
						breadcrumb: "Bulk Loan Reasssignment",
					},
					resolve: {
						offices: OfficesResolver,
					},
				},
				{
					...
					data: {
						...
						breadcrumb: "Entity Data Table Checks",
					},
					children: [
						{
							path: "",
						...
						},
						{
							...
							data: {
								title: "Create Entity Data Table Checks",
								breadcrumb: "Create",
							},
							resolve: {
				...
				},
				{
					...
					children: [
						...
						},
						{
							...
							data: {
								title: "View Bulk Import",
								routeParamBreadcrumb: "import-name",
							},
							resolve: {
								offices: OfficesResolver,
