...
export class EditLoanProvisioningCriteriaComponent implements OnInit {
	...
	constructor(
		...
		this.route.data.subscribe(
			(data: { loanProvisioningCriteriaAndTemplate: any }) => {
				this.loanProvisioningCriteriaAndTemplate =
					data.loanProvisioningCriteriaAndTemplate;
				this.definitions = this.loanProvisioningCriteriaAndTemplate.definitions;
				this.loanProducts =
					this.loanProvisioningCriteriaAndTemplate.loanProducts.concat(
						this.loanProvisioningCriteriaAndTemplate.selectedLoanProducts,
					);
				this.liabilityAccounts =
					this.loanProvisioningCriteriaAndTemplate.glAccounts.filter(
