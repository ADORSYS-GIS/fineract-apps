...
export class OrganizationService {
	...
	getProvisioningCriteria(
		...
		return this.http.get(`/provisioningcriteria/${provisioningId}`, {
			params: httpParams,
		});
	}
	...
	getOfficeTemplate(officeId: string): Observable<any> {
		...
		return this.http.get(`/loans/loanreassignment/template`, {
			params: httpParams,
		});
	}
	...
	getOfficeDatatable(officeId: string, datatableName: string): Observable<any> {
		...
		return this.http.get(`/datatables/${datatableName}/${officeId}`, {
			params: httpParams,
		});
	}
	 ...
	 * @returns {Observable<any>}
	 */
	addOfficeDatatableEntry(
		officeId: string,
		datatableName: string,
		data: any,
	): Observable<any> {
		const httpParams = new HttpParams().set("genericResultSet", "true");
		return this.http.post(`/datatables/${datatableName}/${officeId}`, data, {
			params: httpParams,
		});
	}
	...
	editOfficeDatatableEntry(
		...
		const httpParams = new HttpParams().set("genericResultSet", "true");
		return this.http.put(`/datatables/${datatableName}/${officeId}`, data, {
			params: httpParams,
		});
	}
	...
	deleteDatatableContent(
		...
		const httpParams = new HttpParams().set("genericResultSet", "true");
		return this.http.delete(`/datatables/${datatableName}/${officeId}`, {
			params: httpParams,
		});
	}
	 ...
	 * @returns {Observable<any>}
	 */
	executeSmsCampaignCommand(
		campaignId: string,
		data: any,
		command: string,
	): Observable<any> {
		const httpParams = new HttpParams().set("command", command.toString());
		return this.http.post(`/smscampaigns/${campaignId}`, data, {
			params: httpParams,
		});
	}
	...
	getMessagebyStatus(SMS: any): Observable<any> {
		...
		httpParams = SMS.fromDate
			? httpParams.set("fromDate", SMS.fromDate)
			: httpParams;
		httpParams = SMS.toDate ? httpParams.set("toDate", SMS.toDate) : httpParams;
		return this.http.get(`/sms/${SMS.id}/messageByStatus`, {
			params: httpParams,
		});
	}
	...
	activateHoliday(holidayId: string): Observable<any> {
		...
		return this.http.post(`/holidays/${holidayId}`, null, {
			params: httpParams,
		});
	}
	...
	getStandingInstructions(instruction: any): Observable<any> {
		...
		return this.http.get(`/standinginstructionrunhistory`, {
			params: httpParams,
		});
	}
	...
	uploadImportDocument(
		...
		return this.http.post(`${urlSuffix}/uploadtemplate`, formData, {
			params: httpParams,
		});
	}
}
