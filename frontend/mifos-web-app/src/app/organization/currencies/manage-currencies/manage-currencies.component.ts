	...
	implements OnInit, AfterViewInit, OnDestroy, OnChanges
{
	...
	@ViewChild("templateCurrencyFormRef")
	templateCurrencyFormRef: TemplateRef<any>;

	/** Currency data. */
	protected currencyData: ReplaySubject<Currency[]> = new ReplaySubject<
		Currency[]
	>(1);
	...
	ngOnInit() {
		...
		this.noEntriesFoundLabel = this.translateService.instant(
	...
	addCurrency() {
		...
		const selectedCurrencyCodes: any[] = this.selectedCurrencies.map(
