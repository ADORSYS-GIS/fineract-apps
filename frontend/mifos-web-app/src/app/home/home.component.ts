...
export class HomeComponent implements OnInit, AfterViewInit {
	...
	@ViewChild("buttonDashboard", { static: false })
	buttonDashboard: ElementRef<any>;
	...
	@ViewChild("searchActivity", { static: false })
	searchActivity: ElementRef<any>;
	/* Template for popover on search activity */
	@ViewChild("templateSearchActivity", { static: false })
	templateSearchActivity: TemplateRef<any>;
