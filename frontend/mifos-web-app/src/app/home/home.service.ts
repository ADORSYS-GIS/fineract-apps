...
export class HomeService {
	...
	getCollectedAmount(officeId: number): Observable<any> {
		...
		return this.http.get("/runreports/Demand Vs Collection", {
			params: httpParams,
		});
	}
	...
	getDisbursedAmount(officeId: number): Observable<any> {
		const httpParams = new HttpParams()
			.set("R_officeId", officeId.toString())
			.set("genericResultSet", "false");
		return this.http.get("/runreports/Disbursal Vs Awaitingdisbursal", {
			params: httpParams,
		});
	}
	...
	getClientTrendsByDay(officeId: number): Observable<any> {
		const httpParams = new HttpParams()
			.set("R_officeId", officeId.toString())
			.set("genericResultSet", "false");
		return this.http.get("/runreports/ClientTrendsByDay", {
			params: httpParams,
		});
	}
	...
	getClientTrendsByWeek(officeId: number): Observable<any> {
		const httpParams = new HttpParams()
			.set("R_officeId", officeId.toString())
			.set("genericResultSet", "false");
		return this.http.get("/runreports/ClientTrendsByWeek", {
			params: httpParams,
		});
	}
	...
	getClientTrendsByMonth(officeId: number): Observable<any> {
		const httpParams = new HttpParams()
			.set("R_officeId", officeId.toString())
			.set("genericResultSet", "false");
		return this.http.get("/runreports/ClientTrendsByMonth", {
			params: httpParams,
		});
	}
	...
	getLoanTrendsByWeek(officeId: number): Observable<any> {
		const httpParams = new HttpParams()
			.set("R_officeId", officeId.toString())
			.set("genericResultSet", "false");
		return this.http.get("/runreports/LoanTrendsByWeek", {
			params: httpParams,
		});
	}
	...
	getLoanTrendsByMonth(officeId: number): Observable<any> {
		const httpParams = new HttpParams()
			.set("R_officeId", officeId.toString())
			.set("genericResultSet", "false");
		return this.http.get("/runreports/LoanTrendsByMonth", {
			params: httpParams,
		});
	}
}
