			...
			children: [
				{
					...
					children: [
						...
						},
						{
							...
							loadChildren: () =>
								import("../collaterals/collaterals.module").then(
									(m) => m.CollateralsModule,
								),
						},
						{
						...
						},
						{
							...
							loadChildren: () =>
								import(
									"../deposits/recurring-deposits/recurring-deposits.module"
								).then((m) => m.RecurringDepositsModule),
						},
						{
