...
export class CreateClientComponent {
	...
	@ViewChildren("dtclient")
	clientDatatables: QueryList<ClientDatatableStepComponent>;
	...
	constructor(
		...
		this.route.data.subscribe(
			(data: { clientTemplate: any; clientAddressFieldConfig: any }) => {
	...
	areFormvalids(): boolean {
		...
		if (
			...
			this.clientDatatables.forEach(
				(clientDatatable: ClientDatatableStepComponent) => {
