...
export class DatatableSingleRowComponent implements OnInit {
	...
	add() {
		...
		const columns = this.datatables.filterSystemColumns(
		...
		const addDialogRef = this.dialog.open(FormDialogComponent, {
			data,
			width: "50rem",
		});
