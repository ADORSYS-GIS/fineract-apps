...
@Component({
	...
	imports: [...STANDALONE_SHARED_IMPORTS, NgClass, MatDivider, DatePipe],
})
export class FooterComponent implements OnInit, OnDestroy {
	...
	setBusinessDate(): void {
		this.systemService
			.getBusinessDate(SettingsService.businessDateType)
			.subscribe((data: any) => {
