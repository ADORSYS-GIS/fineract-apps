...
@Component({
	...
	imports: [...STANDALONE_SHARED_IMPORTS, NgxMatSelectSearchModule, AsyncPipe],
})
export class GlAccountSelectorComponent
	implements OnInit, OnChanges, OnDestroy
{
	...
	/** GL Account data. */
	protected glAccountData: ReplaySubject<GLAccount[]> = new ReplaySubject<
		GLAccount[]
	>(1);
