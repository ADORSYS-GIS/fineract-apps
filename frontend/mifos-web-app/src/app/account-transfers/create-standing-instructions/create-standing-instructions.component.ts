...
export class CreateStandingInstructionsComponent implements OnInit {
	...
	/** Sets options value */
	setOptions() {
		this.transferTypeData =
			this.standingIntructionsTemplate.transferTypeOptions;
		...
		this.fromAccountTypeData =
			this.standingIntructionsTemplate.fromAccountTypeOptions;
		...
		this.toAccountTypeData =
			this.standingIntructionsTemplate.toAccountTypeOptions;
		this.toAccountData = this.standingIntructionsTemplate.toAccountOptions;
		this.instructionTypeData =
			this.standingIntructionsTemplate.instructionTypeOptions;
		this.recurrenceTypeData =
			this.standingIntructionsTemplate.recurrenceTypeOptions;
		this.recurrenceFrequencyTypeData =
			this.standingIntructionsTemplate.recurrenceFrequencyOptions;
	}
