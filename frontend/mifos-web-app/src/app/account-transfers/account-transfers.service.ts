...
export class AccountTransfersService {
	...
	updateStandingInstructionsData(
		...
		return this.http.put(
			`/standinginstructions/${standinginstructionsId}`,
			data,
			{ params: httpParams },
		);
	}
	...
	deleteStandingInstrucions(id: any) {
		...
		return this.http.delete(`/standinginstructions/${id}`, {
			params: httpParams,
		});
	}

	getStandingInstructionsTransactions(
		standingInstructionsId: any,
		dateFormat: any,
		locale: any,
	) {
