...
export class CreateJournalEntryComponent implements OnInit, AfterViewInit {
	...
	@ViewChild("templateCreateJournalFormRef")
	templateCreateJournalFormRef: TemplateRef<any>;
	 ...
	 */
	removeAffectedGLEntry(
		affectedGLEntryFormArray: UntypedFormArray,
		index: number,
	) {
	...
	ngAfterViewInit() {
		...
		if (this.assetExternalizationEnabled) {
			this.journalEntryForm.addControl(
				"externalAssetOwner",
