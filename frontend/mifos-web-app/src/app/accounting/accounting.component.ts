...
export class AccountingComponent implements AfterViewInit {
	...
	@ViewChild("templateChartofAccounts")
	templateChartofAccounts: TemplateRef<any>;
	...
	@ViewChild("templateMigrateOpeningBalances")
	templateMigrateOpeningBalances: TemplateRef<any>;
	...
	@ViewChild("templateCreateJournalEntries")
	templateCreateJournalEntries: TemplateRef<any>;
