			...
			children: [
				...
				},
				{
					...
					data: {
						...
						breadcrumb: "Financial Activity Mappings",
					},
					children: [
						{
							path: "",
						...
						},
						{
							...
							data: {
								title: "Create Financial Activity Mapping",
								breadcrumb: "Create",
							},
							resolve: {
						...
						},
						{
							path: "view/:id",
							data: {
								title: "View Financial Activity Mapping",
								routeParamBreadcrumb: "id",
							},
							children: [
								{
								...
								},
								{
									...
									resolve: {
										financialActivityAccountAndTemplate:
				...
				},
				{
					...
					data: {
						...
						breadcrumb: "Migrate Opening Balances",
					},
					resolve: {
						offices: OfficesResolver,
						currencies: CurrenciesResolver,
				...
				},
				{
					...
					children: [
						...
						},
						{
							...
							data: {
								title: "Create Accounting Closure",
								breadcrumb: "Create",
							},
							resolve: {
								offices: OfficesResolver,
				...
				},
				{
					...
					children: [
						...
						},
						{
							path: "view/:id",
							data: {
								title: "View Accounting Rule",
								routeResolveBreadcrumb: ["accountingRule", "name"],
							},
							resolve: {
				...
				},
				{
					...
					data: {
						...
						breadcrumb: "Provisioning Entries",
					},
					children: [
						{
							path: "",
							...
							children: [
								{
									...
									data: {
										title: "View Provisioning Journal Entry",
										routeParamBreadcrumb: "id",
									},
									resolve: {
										provisioningJournalEntries:
