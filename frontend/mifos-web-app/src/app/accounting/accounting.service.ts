...
export class AccountingService {
	...
	revertTransaction(transactionId: string, comments: string): Observable<any> {
		...
		return this.http.post(`/journalentries/${transactionId}`, data, {
			params: httpParams,
		});
	}
	...
	retrieveOpeningBalances(officeId: string): Observable<any> {
		...
		return this.http.get("/journalentries/openingbalance", {
			params: httpParams,
		});
	}
	...
	defineOpeningBalances(openingBalances: any): Observable<any> {
		...
		return this.http.post(`/journalentries`, openingBalances, {
			params: httpParams,
		});
	}
	...
	updateAccountingClosure(
		...
		return this.http.put(
			`/glclosures/${accountingClosureId}`,
			accountingClosure,
		);
	}
	...
	getProvisioningEntryEntries(provisioningEntryId: string): Observable<any> {
		...
		return this.http.get("/provisioningentries/entries", {
			params: httpParams,
		});
	}
	...
	getProvisioningJournalEntries(provisioningEntryId: string): Observable<any> {
		const httpParams = new HttpParams().set("entryId", provisioningEntryId);
		return this.http.get("/journalentries/provisioning", {
			params: httpParams,
		});
	}
