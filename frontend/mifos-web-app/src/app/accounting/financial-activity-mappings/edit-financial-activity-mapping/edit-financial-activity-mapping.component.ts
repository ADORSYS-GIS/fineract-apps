...
export class EditFinancialActivityMappingComponent implements OnInit {
	...
	constructor(
		...
		this.route.data.subscribe(
			(data: { financialActivityAccountAndTemplate: any }) => {
				this.financialActivityAccountId =
					data.financialActivityAccountAndTemplate.id;
				this.financialActivityId =
					data.financialActivityAccountAndTemplate.financialActivityData.id;
				this.glAccountId =
					data.financialActivityAccountAndTemplate.glAccountData.id;
				this.glAccountOptions =
					data.financialActivityAccountAndTemplate.glAccountOptions;
	...
	ngOnInit() {
		...
		this.financialActivityMappingForm
			...
			.setValue(this.financialActivityId);
		this.financialActivityMappingForm
			.get("glAccountId")
			.setValue(this.glAccountId);
	}
