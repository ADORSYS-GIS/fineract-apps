...
export class FinancialActivityMappingsComponent
	implements OnInit, AfterViewInit
{
	...
	@ViewChild("templateButtonDefineMapping")
	templateButtonDefineMapping: TemplateRef<any>;
	...
	@ViewChild("templateActivitiesTable")
	templateActivitiesTable: TemplateRef<any>;
