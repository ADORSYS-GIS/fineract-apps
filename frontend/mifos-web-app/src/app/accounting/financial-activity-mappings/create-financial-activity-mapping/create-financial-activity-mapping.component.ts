...
export class CreateFinancialActivityMappingComponent implements OnInit {
	...
	constructor(
		...
		this.route.data.subscribe(
			(data: { financialActivityAccountsTemplate: any }) => {
				this.glAccountOptions =
					data.financialActivityAccountsTemplate.glAccountOptions;
				this.financialActivityData =
					data.financialActivityAccountsTemplate.financialActivityOptions;
			},
		);
	}
	...
	submit() {
		this.accountingService
			...
			.subscribe((response: any) => {
				this.router.navigate(["../view", response.resourceId], {
