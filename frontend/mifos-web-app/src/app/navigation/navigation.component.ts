...
export class NavigationComponent implements OnInit {
	...
	@ViewChild(OfficeNavigationComponent)
	officeNavigationComponent: OfficeNavigationComponent;
	@ViewChild(StaffNavigationComponent)
	staffNavigationComponent: StaffNavigationComponent;
	@ViewChild(CenterNavigationComponent)
	centerNavigationComponent: CenterNavigationComponent;
	@ViewChild(GroupNavigationComponent)
	groupNavigationComponent: GroupNavigationComponent;
	@ViewChild(ClientNavigationComponent)
	clientNavigationComponent: ClientNavigationComponent;
	...
	setOfficeSelector() {
		this.officeSelector.valueChanges.subscribe((officeId) => {
			...
			this.selectedItem = this.officeData.find(
				(office: any) => office.id === officeId,
			);
	...
	setEmployeeSelector() {
		this.employeeSelector.valueChanges.subscribe((employeeId) => {
			if (employeeId) {
				...
				this.groupData = null;
				this.clientData = null;
				this.selectedItem = this.employeeData.find(
