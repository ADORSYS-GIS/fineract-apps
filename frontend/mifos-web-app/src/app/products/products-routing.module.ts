			...
			children: [
									...
									children: [
										{
											...
											data: {
												...
												routeParamBreadcrumb: "datatableName",
											},
											resolve: {
											...
											children: [
												{
													...
													resolve: {
														savingProductDatatable:
															SavingProductDatatableResolver,
													},
												},
											],
										},
								...
								},
								{
									...
									children: [
										...
										},
										{
											...
											data: {
												title: "View Dividend",
												routeParamBreadcrumb: "dividendId",
											},
											resolve: {
				...
				},
				{
					...
					data: {
						...
						breadcrumb: "Manage Tax Configurations",
					},
					children: [
						{
							path: "",
				...
				},
				{
					...
					children: [
						...
						},
						{
							path: "ranges",
							data: {
								title: "Manage Delinquency Ranges",
								breadcrumb: "Delinquency Ranges",
							},
							children: [
								{
									path: "",
						...
						},
						{
							path: "buckets",
							data: {
								title: "Manage Delinquency Bucket",
								breadcrumb: "Delinquency Buckets",
							},
							children: [
								{
									path: "",
								...
								},
								{
									...
									data: {
										title: "Create Delinquency Bucket",
										breadcrumb: "Create",
									},
									resolve: {
										delinquencyRanges: DelinquencyRangeComponentsResolver,
				...
				},
				{
					...
					data: {
						...
						breadcrumb: "Recurring Deposit Products",
					},
					children: [
						{
							path: "create",
							...
							data: {
								title: "Create Recurring Deposit Product",
								breadcrumb: "Create",
							},
							resolve: {
						...
						},
						{
							...
							children: [
								...
								},
								{
									...
									resolve: {
										recurringDepositProductAndTemplate:
				...
				},
				{
					...
					data: {
						...
						breadcrumb: "Fixed Deposit Products",
					},
					children: [
						{
							path: "create",
						...
						},
						{
							...
							children: [
								...
								},
								{
									...
									resolve: {
										fixedDepositProductAndTemplate:
