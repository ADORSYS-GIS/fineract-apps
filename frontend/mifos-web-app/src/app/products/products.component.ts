...
export class ProductsComponent implements AfterViewInit {
	...
	@ViewChild("templateSavingsProducts")
	templateSavingsProducts: TemplateRef<any>;
	...
	@ViewChild("templateFixedDepositProducts")
	templateFixedDepositProducts: TemplateRef<any>;
	/* Reference of recurring deposit products */
	@ViewChild("recurringDepositProducts")
	recurringDepositProducts: ElementRef<any>;
	/* Template for popover on recurring deposit products */
	@ViewChild("templateRecurringDepositProducts")
	templateRecurringDepositProducts: TemplateRef<any>;
	...
	ngAfterViewInit() {
		if (this.configurationWizardService.showCharges === true) {
			setTimeout(() => {
				this.showPopover(
					this.templateCharges,
					this.charges.nativeElement,
					"bottom",
					true,
				);
			});
