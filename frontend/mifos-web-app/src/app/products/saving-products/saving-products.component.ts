...
export class SavingProductsComponent implements OnInit, AfterViewInit {
	...
	@ViewChild("templateButtonSavingProduct")
	templateButtonSavingProduct: TemplateRef<any>;
	...
	@ViewChild("templateSavingProductTable")
	templateSavingProductTable: TemplateRef<any>;
