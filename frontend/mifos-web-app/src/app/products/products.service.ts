...
export class ProductsService {
	...
	createDividend(shareProductId: string, dividendData: any): Observable<any> {
		return this.http.post(
			`/shareproduct/${shareProductId}/dividend`,
			dividendData,
		);
	}
	...
	getDividendData(shareProductId: any, dividendId: any): Observable<any> {
		...
		return this.http.get(
			`/shareproduct/${shareProductId}/dividend/${dividendId}`,
			{ params: httpParams },
		);
	}
	...
	updateFixedDepositProduct(
		fixedDepositProductId: any,
		fixedDepositProduct: any,
	): Observable<any> {
		return this.http.put(
			`/fixeddepositproducts/${fixedDepositProductId}`,
			fixedDepositProduct,
		);
	}
	...
	updateDelinquencyBucket(
		...
		return this.http.put(
			`/delinquency/buckets/${delinquencyBucketId}`,
			payload,
		);
	}
	...
	getProductMixTemplate(productMixId: string): Observable<any> {
		...
		return this.http.get(`/loanproducts/${productMixId}/productmix`, {
			params: httpParams,
		});
	}
	...
	createProductMix(productMix: any, productMixId: string): Observable<any> {
		return this.http.post(
			`/loanproducts/${productMixId}/productmix`,
			productMix,
		);
	}
	...
	getCollateral(
		...
		const httpParams = new HttpParams().set("template", template.toString());
		return this.http.get(`/collateral-management/${collateralId}`, {
			params: httpParams,
		});
	}
	...
	getProductDatatable(productId: string, datatableName: string) {
		...
		return this.http.get(`/datatables/${datatableName}/${productId}`, {
			params: httpParams,
		});
	}
	 ...
	 * @returns {Observable<any>}
	 */
	editProductDatatableEntry(
		productId: string,
		datatableName: string,
		data: any,
	) {
		const httpParams = new HttpParams().set("genericResultSet", "true");
		return this.http.put(`/datatables/${datatableName}/${productId}`, data, {
			params: httpParams,
		});
	}
	...
	deleteDatatableContent(productId: string, datatableName: string) {
		const httpParams = new HttpParams().set("genericResultSet", "true");
		return this.http.delete(`/datatables/${datatableName}/${productId}`, {
			params: httpParams,
		});
	}
}
