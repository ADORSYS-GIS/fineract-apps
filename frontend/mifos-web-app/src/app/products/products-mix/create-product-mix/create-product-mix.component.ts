		...
		this.productMixForm.get("productId").valueChanges.subscribe((productId) => {
			...
			this.productsService
				...
				.subscribe((productMixTemplateData: any) => {
					const restrictedProductsData =
						productMixTemplateData.restrictedProducts;
					this.productData = [
					...
					this.productMixForm
						...
						.setValue([
							...restrictedProductsData.map(
								(restrictedProduct: any) => restrictedProduct.id,
							),
						]);
				});
		});
	...
	submit() {
		...
		this.productsService
			...
			.subscribe((response: any) => {
				this.router.navigate(["../", response.productId], {
