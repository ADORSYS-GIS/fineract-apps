...
export class CreateLoanProductComponent implements OnInit {
	...
	constructor(
		...
		this.route.data.subscribe(
			(data: { loanProductsTemplate: any; configurations: any }) => {
			...
			if (this.loanProductsTemplate.enableIncomeCapitalization) {
				this.deferredIncomeRecognition.capitalizedIncome = {
					...
					capitalizedIncomeCalculationType:
						this.loanProductsTemplate
							.capitalizedIncomeCalculationTypeOptions[0],
					capitalizedIncomeStrategy:
						this.loanProductsTemplate.capitalizedIncomeStrategyOptions[0],
					capitalizedIncomeType:
						this.loanProductsTemplate.capitalizedIncomeTypeOptions[0],
				};
			} else {
				this.deferredIncomeRecognition.capitalizedIncome = {
			...
			if (this.loanProductsTemplate.enableBuyDownFee) {
				this.deferredIncomeRecognition.buyDownFee = {
					...
					buyDownFeeCalculationType:
						this.loanProductsTemplate.buyDownFeeCalculationTypeOptions[0],
					buyDownFeeStrategy:
						this.loanProductsTemplate.buyDownFeeStrategyOptions[0],
					buyDownFeeIncomeType:
						this.loanProductsTemplate.buyDownFeeIncomeTypeOptions[0],
