...
@Component({
	...
	imports: [...STANDALONE_SHARED_IMPORTS, MatTooltip],
})
export class LoanProductInterestRefundStepComponent implements OnInit {
	@Input() loanProductsTemplate: any;
	@Output() supportedInterestRefundTypes = new EventEmitter<
	...
	ngOnInit() {
		...
		const values: StringEnumOptionData[] =
			this.loanProductsTemplate.supportedInterestRefundTypes;
		const supportedInterestRefundTypes: string[] =
			this.mapStringEnumOptionToIdList(values);
