...
export class LoanProductsComponent implements OnInit, AfterViewInit {
	...
	@ViewChild("buttonCreateLoanProduct")
	buttonCreateLoanProduct: ElementRef<any>;
	/* Template for popover on create loan product button */
	@ViewChild("templateButtonCreateLoanProduct")
	templateButtonCreateLoanProduct: TemplateRef<any>;
	...
	@ViewChild("templateLoanProductsTable")
	templateLoanProductsTable: TemplateRef<any>;
