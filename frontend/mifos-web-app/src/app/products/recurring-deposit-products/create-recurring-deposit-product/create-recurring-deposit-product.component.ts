...
export class CreateRecurringDepositProductComponent {
	...
	@ViewChild(RecurringDepositProductInterestRateChartStepComponent, {
		static: true,
	})
	...
	constructor(
		...
		this.route.data.subscribe(
			(data: { recurringDepositProductsTemplate: any }) => {
				this.recurringDepositProductsTemplate =
					data.recurringDepositProductsTemplate;
			},
		);
	...
	get recurringDepositProductAccountingForm() {
		return this.recurringDepositProductAccountingStep
	...
	get recurringDepositProduct() {
		return {
			...
			...this.recurringDepositProductCurrencyStep
				.recurringDepositProductCurrency,
			...this.recurringDepositProductTermsStep.recurringDepositProductTerms,
			...this.recurringDepositProductSettingsStep
				.recurringDepositProductSettings,
			...this.recurringDepositProductInterestRateChartStep
				.recurringDepositProductInterestRateChart,
			...this.recurringDepositProductChargesStep.recurringDepositProductCharges,
			...this.recurringDepositProductAccountingStep
				.recurringDepositProductAccounting,
		};
	}
	...
	submit() {
		...
		const recurringDepositProduct = {
			...
			charges: this.recurringDepositProduct.charges.map((charge: any) => ({
				id: charge.id,
			})),
