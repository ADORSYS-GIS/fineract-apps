...
export class RecurringDepositProductAccountingStepComponent implements OnInit {
	...
	ngOnInit() {
		...
		this.penaltyData =
			this.recurringDepositProductsTemplate.penaltyOptions || [];
		this.paymentTypeData =
			this.recurringDepositProductsTemplate.paymentTypeOptions || [];
		this.assetAccountData =
			this.recurringDepositProductsTemplate.accountingMappingOptions
				.assetAccountOptions || [];
		...
		if (this.isCashOrAccrualAccounting()) {
			this.recurringDepositProductAccountingForm.patchValue({
				savingsReferenceAccountId:
					this.recurringDepositProductsTemplate.accountingMappings
			...
			if (
				...
				this.recurringDepositProductsTemplate.paymentChannelToFundSourceMappings.forEach(
					(paymentChannelToFundSourceMapping: any) => {
						const paymentChannelToFundSourceMappingData =
			...
			if (
				...
				this.recurringDepositProductsTemplate.penaltyToIncomeAccountMappings.forEach(
					(penaltyToIncomeAccountMapping: any) => {
						...
						const formArray = this.recurringDepositProductAccountingForm
							.controls["penaltyToIncomeAccountMappings"] as UntypedFormArray;
