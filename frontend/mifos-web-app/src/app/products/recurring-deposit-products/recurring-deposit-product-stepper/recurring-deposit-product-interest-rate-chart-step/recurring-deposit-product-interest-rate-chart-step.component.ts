...
@Component({
	...
	templateUrl:
		"./recurring-deposit-product-interest-rate-chart-step.component.html",
	styleUrls: [
		"./recurring-deposit-product-interest-rate-chart-step.component.scss",
	],
	animations: [
...
export class RecurringDepositProductInterestRateChartStepComponent
	implements OnInit
{
	...
	ngOnInit() {
		this.periodTypeData =
			this.recurringDepositProductsTemplate.chartTemplate.periodTypes;
		this.entityTypeData =
			this.recurringDepositProductsTemplate.chartTemplate.entityTypeOptions;
		...
		this.genderData =
			this.recurringDepositProductsTemplate.chartTemplate.genderOptions;
		this.clientTypeData =
			this.recurringDepositProductsTemplate.chartTemplate.clientTypeOptions;
	...
	assignFormData() {
		...
		const isChartArray = Array.isArray(
			this.recurringDepositProductsTemplate.activeChart,
		);
	...
	get charts(): UntypedFormArray {
		return this.recurringDepositProductInterestRateChartForm.get(
			"charts",
		) as UntypedFormArray;
	}
	...
	getData(formType: string, values?: any) {
		switch (formType) {
			...
			case "Incentive":
				return {
					values,
					chartTemplate: this.recurringDepositProductsTemplate.chartTemplate,
				};
		}
	}
