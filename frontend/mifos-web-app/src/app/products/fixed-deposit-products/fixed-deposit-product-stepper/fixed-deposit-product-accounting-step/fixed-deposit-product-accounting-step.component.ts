...
export class FixedDepositProductAccountingStepComponent implements OnInit {
	...
	ngOnInit() {
		...
		this.paymentTypeData =
			this.fixedDepositProductsTemplate.paymentTypeOptions || [];
		this.assetAccountData =
			this.fixedDepositProductsTemplate.accountingMappingOptions
				.assetAccountOptions || [];
		...
		if (this.isCashOrAccrualAccounting()) {
			this.fixedDepositProductAccountingForm.patchValue({
				savingsReferenceAccountId:
					this.fixedDepositProductsTemplate.accountingMappings
