...
export class FixedDepositProductsComponent implements OnInit, AfterViewInit {
	...
	@ViewChild("buttonCreateFixedProduct")
	buttonCreateFixedProduct: ElementRef<any>;
	/* Template for popover on create fixed product button */
	@ViewChild("templateButtonCreateFixedProduct")
	templateButtonCreateFixedProduct: TemplateRef<any>;
	...
	@ViewChild("templateFixedProductsTable")
	templateFixedProductsTable: TemplateRef<any>;
