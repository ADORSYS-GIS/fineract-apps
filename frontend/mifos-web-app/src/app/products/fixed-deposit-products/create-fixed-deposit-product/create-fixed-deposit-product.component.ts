...
export class CreateFixedDepositProductComponent {
	...
	@ViewChild(FixedDepositProductInterestRateChartStepComponent, {
		static: true,
	})
	...
	get fixedDepositProductInterestRateChartForm() {
		return this.fixedDepositProductInterestRateChartStep
			.fixedDepositProductInterestRateChartForm;
	}

	get fixedDepositProductAccountingForm() {
		return this.fixedDepositProductAccountingStep
			.fixedDepositProductAccountingForm;
	}
	...
	get fixedDepositProduct() {
		return {
			...
			...this.fixedDepositProductInterestRateChartStep
				.fixedDepositProductInterestRateChart,
	...
	submit() {
		...
		const fixedDepositProduct = {
			...
			charges: this.fixedDepositProduct.charges.map((charge: any) => ({
				id: charge.id,
			})),
