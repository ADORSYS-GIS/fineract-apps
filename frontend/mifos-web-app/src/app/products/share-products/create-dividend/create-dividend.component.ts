...
export class CreateDividendComponent implements OnInit {
	...
	submit() {
		...
		const prevStartDate: Date =
			this.createDividendForm.value.dividendPeriodStartDate;
		const prevEndDate: Date =
			this.createDividendForm.value.dividendPeriodEndDate;
		if (createDividendFormData.dividendPeriodStartDate instanceof Date) {
			createDividendFormData.dividendPeriodStartDate =
