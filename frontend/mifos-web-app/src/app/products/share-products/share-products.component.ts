...
export class ShareProductsComponent implements OnInit, AfterViewInit {
	...
	@ViewChild("buttonCreateShareProduct")
	buttonCreateShareProduct: ElementRef<any>;
	/* Template for popover on create share product button */
	@ViewChild("templateButtonCreateShareProduct")
	templateButtonCreateShareProduct: TemplateRef<any>;
	...
	@ViewChild("templateShareProductsTable")
	templateShareProductsTable: TemplateRef<any>;
