	...
	Route.withShell([
		{
			...
			children: [
				...
				},
				{
					...
					data: {
						title: "Manage External Events",
						breadcrumb: "Manage External Events",
					},
					children: [
						{
							path: "",
				...
				},
				{
					...
					data: {
						...
						breadcrumb: "Entity to Entity Mapping",
					},
					resolve: {
				...
				},
				{
					...
					children: [
						...
						},
						{
							path: "amazon-s3",
							data: {
								title: "View Amazon S3 Configuration",
								breadcrumb: "Amazon S3",
							},
							children: [
								{
									path: "",
								...
								},
								{
									...
									data: {
										title: "Edit Amazon S3 Configuration",
										breadcrumb: "Edit",
									},
									resolve: {
										amazonS3Configuration: AmazonS3ConfigurationResolver,
						...
						},
						{
							path: "notification",
							data: {
								title: "View Notification Configuration",
				...
				},
				{
					...
					data: {
						...
						breadcrumb: "Account Number Preferences",
					},
					children: [
						{
							path: "",
						...
						},
						{
							...
							data: {
								title: "Create Account Number Preference",
								breadcrumb: "Create",
							},
							resolve: {
								accountNumberPreferencesTemplate:
						...
						},
						{
							path: ":id",
							data: {
								title: "View Account Number Preference",
