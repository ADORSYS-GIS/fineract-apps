...
export class EditDataTableComponent implements OnInit {
	...
	initData() {
		...
		this.dataTableChangesData.apptableName =
		...
		this.showEntitySubType =
			this.dataTableData.applicationTableName === "m_client";
	}
	...
	createDataTableForm() {
		this.dataTableForm = this.formBuilder.group({
			...
			entitySubType: [
				{ value: this.dataTableData.entitySubType, disabled: true },
			],
		});
	}
