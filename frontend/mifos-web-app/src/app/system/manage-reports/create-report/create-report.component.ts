...
export class CreateReportComponent implements OnInit {
	...
	constructor(
		...
		this.route.data.subscribe((data: { reportTemplate: any }) => {
			...
			this.dataForDialog.allowedParameters =
				this.reportTemplateData.allowedParameters;
		});
	}
	 ...
	 */
	submit() {
		this.reportForm.value.reportParameters = this.reportParametersData.map(
			function (reportParameter: any) {
