...
export class UsersComponent implements OnInit, AfterViewInit {
	...
	@ViewChild("paginatorZitadel", { static: true })
	paginatorZitadel!: MatPaginator;
	...
	@ViewChild("templateButtonCreateUser")
	templateButtonCreateUser!: TemplateRef<any>;
	...
	ngAfterViewInit() {
		...
		if (this.configurationWizardService.showUsersList) {
			setTimeout(() => {
				this.showPopover(
					this.templateUsersTable,
					this.usersTable.nativeElement,
					"top",
					true,
				);
			});
