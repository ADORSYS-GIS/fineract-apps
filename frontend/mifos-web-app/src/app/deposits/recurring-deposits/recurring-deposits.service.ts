...
export class RecurringDepositsService {
	...
	getRecurringDepositsAccountData(
		...
		return this.http.get(
			`/recurringdepositaccounts/${recurringDepositAccountId}`,
			{ params: httpParams },
		);
	}
	 ...
	 */
	getRecurringDepositsAccountTemplate(
		clientId: any,
		productId?: any,
	): Observable<any> {
		...
		httpParams = productId
			...
			: httpParams;
		return this.http.get(`/recurringdepositaccounts/template`, {
			params: httpParams,
		});
	}
	...
	executeRecurringDepositsAccountCommand(
		...
		return this.http.post(`/recurringdepositaccounts/${accountId}`, data, {
			params: httpParams,
		});
	}
	...
	getRecurringDepositsAccountAndTemplate(accountId: any) {
		const httpParams = new HttpParams()
			...
			.set("template", "true");
		return this.http.get(`/recurringdepositaccounts/${accountId}`, {
			params: httpParams,
		});
	}
	...
	updateRecurringDepositAccount(
		accountId: any,
		recurringDepositAccountData: any,
	): Observable<any> {
	 ...
	 */
	getRecurringDepositAccountActionResource(
		accountId: any,
		command: string,
	): Observable<any> {
		const httpParams = new HttpParams().set("command", command);
		return this.http.get(`/recurringdepositaccounts/${accountId}/template`, {
			params: httpParams,
		});
	}
