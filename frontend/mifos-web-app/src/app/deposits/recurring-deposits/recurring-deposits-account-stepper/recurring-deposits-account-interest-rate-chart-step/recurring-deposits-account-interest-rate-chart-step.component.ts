...
@Component({
	...
	templateUrl:
		"./recurring-deposits-account-interest-rate-chart-step.component.html",
	styleUrls: [
		"./recurring-deposits-account-interest-rate-chart-step.component.scss",
	],
	animations: [
...
export class RecurringDepositsAccountInterestRateChartStepComponent
