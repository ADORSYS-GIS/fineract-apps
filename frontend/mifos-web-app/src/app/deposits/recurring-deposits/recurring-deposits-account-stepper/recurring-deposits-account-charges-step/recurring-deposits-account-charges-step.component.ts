...
export class RecurringDepositsAccountChargesStepComponent
	implements OnInit, OnChanges
{
	...
	ngOnInit() {
		...
		if (
			this.recurringDepositsAccountTemplate.id &&
			this.recurringDepositsAccountTemplate.charges
		) {
			this.chargesDataSource =
	...
	ngOnChanges() {
		...
		if (this.recurringDepositsAccountProductTemplate) {
			this.chargeData =
				this.recurringDepositsAccountProductTemplate.chargeOptions.filter(
