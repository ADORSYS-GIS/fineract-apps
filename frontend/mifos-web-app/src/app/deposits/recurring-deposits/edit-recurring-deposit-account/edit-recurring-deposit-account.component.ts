...
export class EditRecurringDepositAccountComponent {
	...
	constructor(
		...
		this.route.data.subscribe(
			(data: { recurringDepositsAccountAndTemplate: any }) => {
				this.recurringDepositsAccountAndTemplate =
					data.recurringDepositsAccountAndTemplate;
			},
		);
	}
	...
	get recurringDepositAccountDetailsForm() {
		return this.recurringDepositsAccountDetailsStep
			.recurringDepositAccountDetailsForm;
	}

	/** Get Recurring Deposit Account Terms Form Data */
	get recurringDepositAccountTermsForm() {
		return this.recurringDepositAccountTermsStep
			.recurringDepositAccountTermsForm;
	}

	/** Get Recurring Deposit Account Settings Form Data */
	get recurringDepositAccountSettingsForm() {
		return this.recurringDepositAccountSettingsStep
			.recurringDepositAccountSettingsForm;
	}
