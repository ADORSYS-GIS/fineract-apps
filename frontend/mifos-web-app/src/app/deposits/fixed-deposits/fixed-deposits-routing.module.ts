			...
			},
			{
				...
				children: [
					...
					},
					{
						...
						resolve: {
							fixedDepositsAccountAndTemplate:
					...
					},
					{
						...
						children: [
							...
							},
							{
								...
								loadChildren: () =>
									import(
										"../../account-transfers/account-transfers.module"
									).then((m) => m.AccountTransfersModule),
							},
							{
								path: ":id",
								...
								children: [
									{
										...
										resolve: {
											fixedDepositsAccountTransaction:
