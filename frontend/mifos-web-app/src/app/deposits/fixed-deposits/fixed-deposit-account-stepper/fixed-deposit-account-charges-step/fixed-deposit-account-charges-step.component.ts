...
export class FixedDepositAccountChargesStepComponent
	implements OnInit, OnChanges
{
	...
	ngOnInit() {
		...
		if (
			this.fixedDepositsAccountTemplate.id &&
			this.fixedDepositsAccountTemplate.charges
		) {
			this.chargesDataSource =
	...
	ngOnChanges() {
		...
		if (this.fixedDepositsAccountProductTemplate) {
			this.chargeData =
				this.fixedDepositsAccountProductTemplate.chargeOptions.filter(
	...
	editChargeAmount(charge: any) {
		...
		const editChargeAmountDialogRef = this.dialog.open(FormDialogComponent, {
			data,
		});
	...
	editChargeDate(charge: any) {
		...
		const editChargeDateDialogRef = this.dialog.open(FormDialogComponent, {
			data,
		});
	...
	editChargeFeeInterval(charge: any) {
		...
		const editChargeFeeIntervalDialogRef = this.dialog.open(
			FormDialogComponent,
			{ data },
		);
