...
@Component({
	...
	templateUrl:
		"./fixed-deposit-account-interest-rate-chart-step.component.html",
	styleUrls: [
		"./fixed-deposit-account-interest-rate-chart-step.component.scss",
	],
	animations: [
...
export class FixedDepositAccountInterestRateChartStepComponent
