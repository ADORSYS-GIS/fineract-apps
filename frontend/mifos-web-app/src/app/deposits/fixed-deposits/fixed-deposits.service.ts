...
export class FixedDepositsService {
	...
	getFixedDepositsAccountData(accountId: string): Observable<any> {
		...
		return this.http.get(`/fixeddepositaccounts/${accountId}`, {
			params: httpParams,
		});
	}
	...
	executeFixedDepositsAccountCommand(
		...
		return this.http.post(`/fixeddepositaccounts/${accountId}`, data, {
			params: httpParams,
		});
	}
	 ...
	 * @returns {Observable<any>}
	 */
	getFixedDepositsAccountTransaction(
		accountId: string,
	...
	getFixedDepositsAccountClosureTemplate(accountId: string): Observable<any> {
		...
		return this.http.get(`/fixeddepositaccounts/${accountId}/template`, {
			params: httpParams,
		});
	}
	 ...
	 * @returns {Observable<any>}
	 */
	getFixedDepositsAccountTransactionTemplate(
		accountId: string,
	): Observable<any> {
		return this.http.get(
			`/fixeddepositaccounts/${accountId}/transactions/template`,
		);
	}
	 ...
	 */
	getFixedDepositsAccountTemplate(
		clientId: string,
		productId?: string,
	): Observable<any> {
		...
		httpParams = productId
			...
			: httpParams;
		return this.http.get("/fixeddepositaccounts/template", {
			params: httpParams,
		});
	}
