...
export class CentersViewComponent implements OnInit {
	...
	constructor(
		...
		this.route.data.subscribe(
			(data: { centerViewData: any; centerDatatables: any }) => {
	...
	get editMeeting() {
		if (this.centerViewData.collectionMeetingCalendar) {
			const entityType =
				this.centerViewData.collectionMeetingCalendar.entityType.value;
			if (
				entityType === "CENTERS" &&
