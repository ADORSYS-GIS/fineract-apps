...
export class CentersService {
	...
	getCenterDatatable(centerId: string, datatableName: string) {
		...
		return this.http.get(`/datatables/${datatableName}/${centerId}`, {
			params: httpParams,
		});
	}
	 ...
	 * @returns {Observable<any>}
	 */
	addCenterDatatableEntry(
		centerId: string,
		datatableName: string,
		data: any,
	): Observable<any> {
		const httpParams = new HttpParams().set("genericResultSet", "true");
		return this.http.post(`/datatables/${datatableName}/${centerId}`, data, {
			params: httpParams,
		});
	}
	 ...
	 * @returns {Observable<any>}
	 */
	editCenterDatatableEntry(
		centerId: string,
		datatableName: string,
		data: any,
	): Observable<any> {
		const httpParams = new HttpParams().set("genericResultSet", "true");
		return this.http.put(`/datatables/${datatableName}/${centerId}`, data, {
			params: httpParams,
		});
	}
	...
	deleteDatatableContent(
		...
		const httpParams = new HttpParams().set("genericResultSet", "true");
		return this.http.delete(`/datatables/${datatableName}/${centerId}`, {
			params: httpParams,
		});
	}
	...
	assignCenterAttendance(
		...
		const httpParams = new HttpParams().set("calenderId", calendarId);
		return this.http.post(`/centers/${centerId}/meetings`, data, {
			params: httpParams,
		});
	}
	...
	getCalendarAndTemplate(centerId: any, calendarId: any): Observable<any> {
		...
		return this.http.get(`/centers/${centerId}/calendars/${calendarId}`, {
			params: httpParams,
		});
	}
