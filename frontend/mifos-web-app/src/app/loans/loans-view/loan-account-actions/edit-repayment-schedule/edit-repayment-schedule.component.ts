...
@Component({
	...
	imports: [...STANDALONE_SHARED_IMPORTS, RepaymentScheduleTabComponent],
})
export class EditRepaymentScheduleComponent implements OnInit {
	...
	reset(): void {
		const recoverScheduleDialogRef = this.dialog.open(
			ConfirmationDialogComponent,
			{
				data: {
					heading: this.translateService.instant(
						"labels.heading.Recover Original Schedule",
					),
		...
		recoverScheduleDialogRef
			.afterClosed()
			.subscribe((responseConfirmation: any) => {
