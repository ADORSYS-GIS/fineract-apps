...
export class LoansService {
	...
	getLoanPrepayLoanActionTemplate(
		loanId: string,
	...
	submitLoanActionButton(loanId: string, data: any, command: any) {
		...
		return this.http.post(`/loans/${loanId}/transactions`, data, {
			params: httpParams,
		});
	}
	...
	getLoanDatatable(loanId: string, datatableName: string) {
		...
		return this.http.get(`/datatables/${datatableName}/${loanId}`, {
			params: httpParams,
		});
	}
	 ...
	 * @returns {Observable<any>}
	 */
	addLoanDatatableEntry(
		loanId: string,
		datatableName: string,
		data: any,
	): Observable<any> {
		const httpParams = new HttpParams().set("genericResultSet", "true");
		return this.http.post(`/datatables/${datatableName}/${loanId}`, data, {
			params: httpParams,
		});
	}
	 ...
	 * @returns {Observable<any>}
	 */
	editLoanDatatableEntry(
		loanId: string,
		datatableName: string,
		data: any,
	): Observable<any> {
		const httpParams = new HttpParams().set("genericResultSet", "true");
		return this.http.put(`/datatables/${datatableName}/${loanId}`, data, {
			params: httpParams,
		});
	}
	 ...
	 * @returns {Observable<any>}
	 */
	deleteDatatableContent(
		loanId: string,
		datatableName: string,
	): Observable<any> {
		const httpParams = new HttpParams().set("genericResultSet", "true");
		return this.http.delete(`/datatables/${datatableName}/${loanId}`, {
			params: httpParams,
		});
	}
	...
	updateInterestPause(
		...
		return this.http.put(
			`/loans/${loanId}/interest-pauses/${variationId}`,
			data,
		);
	}
	...
	applyCommandLoanRescheduleRequests(
		...
		const httpParams = new HttpParams().set("command", command);
		return this.http.post(`/rescheduleloans/${rescheduleId}`, data, {
			params: httpParams,
		});
	}
	...
	downloadLoanDocument(parentEntityId: string, documentId: string) {
		return this.http.get(
			`/loans/${parentEntityId}/documents/${documentId}/attachment`,
			{ responseType: "blob" },
		);
	}
	...
	guarantorAccountResource(loanId: string, clientId: any): Observable<any> {
		...
		return this.http.get(`/loans/${loanId}/guarantors/accounts/template`, {
			params: httpParams,
		});
	}
	...
	executeLoansAccountChargesCommand(
		...
		const httpParams = new HttpParams().set("command", command);
		return this.http.post(`/loans/${accountId}/charges/${chargeId}`, data, {
			params: httpParams,
		});
	}
	...
	applyCommandLoanScheduleVariations(
		...
		return this.http.post(
			`/loans/${loanId}/schedule?command=${command}`,
			payload,
		);
	}
	 ...
	 * @returns {Observable<any>}
	 */
	getLoansAccountTransactionTemplate(
		accountId: string,
		transactionId: string,
	): Observable<any> {
	...
	executeLoansAccountTransactionsCommand(
		...
		return this.http.post(`/loans/${accountId}/transactions`, data, {
			params: httpParams,
		});
	}
	...
	buildLoanRequestPayload(
		...
		const loansAccountData = {
			...
			charges: loansAccount.charges.map((charge: any) => ({
				...
				dueDate:
					charge.dueDate &&
					this.dateUtils.formatDate(charge.dueDate, dateFormat),
			})),
		...
		if (loansAccount.collateral) {
			loansAccountData.collateral = loansAccount.collateral.map(
				(collateralEle: any) => ({
