...
export class CreateGsimAccountComponent {
	...
	constructor(
		...
		this.route.data.subscribe(
			(data: { savingsAccountTemplate: any; groupsData: any }) => {
	...
	get savingsAccount() {
		this.selectedMembers =
			this.savingsActiveClientMembers.selectedClientMembers;
		return {
	...
	setData(client: any, isParentAccount: any): any {
		...
		const data = {
			...
			submittedOnDate: this.dateUtils.formatDate(
				this.savingsAccount.submittedOnDate,
				dateFormat,
			),
			dateFormat,
			monthDayFormat,
