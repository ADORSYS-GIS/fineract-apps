...
export class SavingsService {
	 ...
	 */
	getSavingsTransactionTemplateResource(
		savingAccountId: string,
	): Observable<any> {
		return this.http.get(
			`/savingsaccounts/${savingAccountId}/transactions/template`,
		);
	}
	...
	getSavingsChargeTemplateResource(savingAccountId: string): Observable<any> {
		return this.http.get(
			`/savingsaccounts/${savingAccountId}/charges/template`,
		);
	}
	...
	createSavingsCharge(
		...
		return this.http.post(
			`/savingsaccounts/${savingAccountId}/${resourceType}`,
			savingsCharge,
		);
	}
	...
	getSavingsDatatable(
		...
		return this.http.get(`/datatables/${datatableName}/${accountId}`, {
			params: httpParams,
		});
	}
	 ...
	 * @returns {Observable<any>}
	 */
	getSavingsTransactionDatatable(
		transactionId: string,
		datatableName: string,
	): Observable<any> {
		const httpParams = new HttpParams().set("genericResultSet", "true");
		return this.http.get(`/datatables/${datatableName}/${transactionId}`, {
			params: httpParams,
		});
	}
	 ...
	 * @returns {Observable<any>}
	 */
	editSavingsDatatableEntry(
		accountId: string,
		datatableName: string,
		data: any,
	): Observable<any> {
		const httpParams = new HttpParams().set("genericResultSet", "true");
		return this.http.put(`/datatables/${datatableName}/${accountId}`, data, {
			params: httpParams,
		});
	}
	...
	deleteDatatableContent(
		...
		const httpParams = new HttpParams().set("genericResultSet", "true");
		return this.http.delete(`/datatables/${datatableName}/${accountId}`, {
			params: httpParams,
		});
	}
	...
	executeSavingsAccountCommand(
		...
		return this.http.post(`/savingsaccounts/${accountId}`, data, {
			params: httpParams,
		});
	}
	...
	executeSavingsAccountUpdateCommand(
		...
		const httpParams = new HttpParams().set("command", command);
		return this.http.put(`/savingsaccounts/${accountId}`, data, {
			params: httpParams,
		});
	}
	...
	editSavingsNote(savingAccountId: string, noteId: string, noteData: any) {
		return this.http.put(
			`/savings/${savingAccountId}/notes/${noteId}`,
			noteData,
		);
	}
	...
	downloadSavingsDocument(parentEntityId: string, documentId: string) {
		return this.http.get(
			`/savings/${parentEntityId}/documents/${documentId}/attachment`,
			{ responseType: "blob" },
		);
	}

	deleteSavingsDocument(
		savingAccountId: any,
		documentId: any,
	): Observable<any> {
		return this.http.delete(
			`/savings/${savingAccountId}/documents/${documentId}`,
		);
	}
