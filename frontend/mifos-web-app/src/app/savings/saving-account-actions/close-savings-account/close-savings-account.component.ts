...
export class CloseSavingsAccountComponent implements OnInit {
	...
	constructor(
		...
		this.route.data.subscribe((data: { savingsAccountActionData: any }) => {
			this.paymentTypeOptions =
				data.savingsAccountActionData[0].paymentTypeOptions;
			this.transactionAmount =
				data.savingsAccountActionData[1].summary.accountBalance;
		});
	...
	submit() {
		...
		const prevClosedOnDate: Date =
			this.closeSavingsAccountForm.value.closedOnDate;
