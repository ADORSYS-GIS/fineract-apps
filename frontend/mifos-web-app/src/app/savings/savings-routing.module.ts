		...
		children: [
			{
				...
				data: {
					...
					breadcrumb: "Create Savings Account",
				},
			...
			},
			{
				...
				data: {
					title: "Saving Account View",
					routeParamBreadcrumb: "savingAccountId",
				},
				...
				children: [
					{
						path: "create",
						data: {
							title: "Create GSIM Application",
							breadcrumb: "Create GSIM Application",
						},
