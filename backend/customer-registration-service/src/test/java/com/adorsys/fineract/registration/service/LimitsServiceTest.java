...
//         // Then
//         assertThat(limits.getKycTier()).isEqualTo(1);
//         assertThat(limits.getTierName()).isEqualTo("Basic");
//         assertThat(limits.getLimits().getDailyDepositLimit()).isEqualByComparingTo(BigDecimal.valueOf(50000));
//         assertThat(limits.getLimits().getDailyWithdrawalLimit()).isEqualByComparingTo(BigDecimal.valueOf(25000));
//         assertThat(limits.getLimits().getMonthlyTransactionLimit()).isEqualByComparingTo(BigDecimal.valueOf(200000));
//     }
...
//         assertThat(limits.getLimits().getDailyDepositLimit()).isEqualByComparingTo(BigDecimal.valueOf(500000));
//         assertThat(limits.getLimits().getDailyWithdrawalLimit()).isEqualByComparingTo(BigDecimal.valueOf(200000));
//     }
...
//         // Then
//         assertThat(limits.getKycTier()).isEqualTo(3);
//         assertThat(limits.getTierName()).isEqualTo("Premium");
//         assertThat(limits.getLimits().getDailyDepositLimit()).isEqualByComparingTo(BigDecimal.valueOf(2000000));
//         assertThat(limits.getLimits().getDailyWithdrawalLimit()).isEqualByComparingTo(BigDecimal.valueOf(1000000));
//     }
